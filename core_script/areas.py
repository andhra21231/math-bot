...
print("5. Trapezoid")
print("6. polygon")
print("7. Luas Lingkaran (Khusus Untuk Bilangan Yang Menggunakan Phi 22/7)")
print("8. Luas Lingkaran (Khusus Untuk Bilangan Yang Menggunakan PhI 3.14)")
...
while True:
    ...
    if choice in ('7'):
        num1 = float(input("Masukan Jari-Jari :"))

    if choice == '7':
        print("π Dikali", num1, "Pangkat 2 Sama Dengan", circle(num1))
