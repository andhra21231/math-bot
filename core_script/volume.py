...
print("2. Balok")
print("3. Prisma")
print("4. Silinder Dengan Pi : 22/7 (Kelipatan 7)")
print("5. silinder Dengan Pi : 3.14")
print("6. Piramida")
print("7. bola Dengan Pi : 22/7 (Kelipatan 7)")
print("8. bola Dengan Pi : 3.14")
...
while True:
    ...
    if choice in ('3'):
        num1 = float(input("Masukan Dasar Prisma :"))
        num2 = float(input("Masukan Tinggi Prisma :"))

    if choice == '3':
        print(num1, "Dikali", num2, "Sama Dengan",prism(num1, num2))
    ...
    if choice in ('6'):
        ...
        num2 = float(input("masukan tinggi dari primadinya : "))
